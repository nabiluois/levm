// ===============================
// PANINI : RÔLES DÉTAILLÉS (mode "bloc tout-en-un")
// ===============================
const paniniRoles = [
  {
    id: "LE PAYSAN",
...
<span style="font-size:1.2em;">📜 <strong>Description</strong></span><br>
Séducteur légendaire, il n’a qu’une arme : le charme. Et un don irrésistible pour offrir… des présents dont on ne sort pas toujours vivant.<br>
Pouvoir : Le Cadeau de l’Amour.<br>
Deux fois dans la partie, quand il le souhaite pendant la nuit, Don Juan peut choisir un joueur à qui offrir un cadeau. Au lever du jour, le Maître du Jeu annonce : [Nom du joueur] a reçu un cadeau de Don Juan. Ce joueur devra alors décider publiquement : Ouvrir le cadeau ou le refuser.<br>
...
<span style="font-size:1.2em;">📜 <strong>Description</strong></span><br>
Il est traqué, pisté, visé de toutes parts... Alors il a trouvé la meilleure stratégie : faire porter le chapeau à quelqu’un d’autre.<br>
...
Le roi des suceurs de sang, maître incontesté de la nuit et de ses créatures.<br><br>
...
document.querySelectorAll('.carte-jeu').forEach(carte => {
  carte.addEventListener('click', function(e) {
    ...
    document.querySelectorAll('.carte-jeu').forEach(c => {
  ...
  searchInput.addEventListener('input', function() {
    ...
    const suggestions = cards
      .filter(card => {
        ...
        return title && title.textContent.toLowerCase().includes(value);
      })
    ...
    if (suggestions.length > 0) {
      ...
      suggestionsBox.innerHTML = '<div style="opacity:0.6;">Aucun résultat</div>';
    }
  });
}
